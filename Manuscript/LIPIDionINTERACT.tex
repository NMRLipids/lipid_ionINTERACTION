...
is observed significantly with too low concentrations in simulations compared to experiments~\cite{pabst07}.
...
of NaCl does not affect the structure of these parts of lipids. On the other hand, the presence of multivalent ions or 
...
It should be noted that in the original experiments the absolute value of the $\beta$ order parameter decreased in the presence of cations,
...
- The Na$^+$ partitioning is overestimated in almost all molecular dynamics simulation models, however, from the publicly available
