...
Orange, ionFF~\cite{??}\ &   POPC & 140 (NaCl) & 72 & 2866 & 7 & 0  & 7 & 298 & running & ? &?  \\
Orange, ionFF~\cite{??}\todoi{Appropriate reference for the ion model?}   &   POPC & 510 (NaCl) & 72 & 2802 & 26 & 0  & 26 & 298 & 120 & 60 &?\todoi{Jukka Määttä and Luca Monticelli, please let us know if we can share some files through Zenodo. This is unpublished model.}  \\
Orange, ionFF~\cite{??}  &   POPC & 1000 (NaCl) & 72 & 2780 & 50 & 0  & 50 & 298 & running & ? &? \\
...
\todo{I have already Orange simulations running with 1M and 140mM NaCl concentrations. I think I should still run CHARMM36 with 1M and maybe with close to 150mM. 
Some of the simulations had accidentally over 1M concentration and those are not useful for this plot.} \\
