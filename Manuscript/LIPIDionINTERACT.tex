...
cations~\cite{akutsu81,altenbach84}. Further quantification was made with 
various positively and negatively charged objects \cite{seelig87,scherer89}.
In original experiments only absolute values were measured \cite{akutsu81,altenbach84,seelig87,scherer89}.


increase of $\beta$ and decrease of $\alpha$ segment 
order 
More recent experiments assigned negative sign to the order parameter of the $\beta$ carbon,
...
current knowledge on order parameter signs~\cite{hong95a,hong95b,gross97}, we can conclude 
that $\beta$ and $\alpha$ segment order parameters decrease with bound positive charges 
and increase with bound negative charge. This can be rationalized by electrostatically 
induced changes in choline P-N dipole tilt \cite{seelig87,scherer89}. 
The order parameter decrease related to P-N vector tilting more parallel to membrane plane 
is seen also with decreased hydration leve \cite{botan15}. 

The electrometer concept is best quantifie
order parameter decrease
has been later on quantified by measuring order parameter responses
to 
Figure~\ref{ordPions} shows the head group order parameter values from H$^2$ NMR measurement
...
and therefore supporting the validity of the molecular electrometer in simulations~\cite{akutsu81,altenbach84,seelig87,scherer89}. 
...
to other models (density maxima close to $\pm$2~nm, see Fig.~\ref{CAdensitiesCLEAR}).
The latter value is probably more realistic 
