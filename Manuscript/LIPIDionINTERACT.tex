...
\subsection{Molecular electrometer concept in MD simulations}   
...
for pure PC bilayer without ions on our previous study (Figure 2 in Ref. \cite{botan15}), 
...
was qualitatively reproduced by the models \cite{botan15}. 
...
from simulations depends on the definition of bound ions, thus this is left for further
studies.
\begin{figure}[]
  \centering
...
\subsection{Comparison between different simulation parameters}
