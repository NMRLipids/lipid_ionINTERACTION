...
Figure~\ref{ordPions} shows the head group order parameters values from H$^2$ NMR measurement
...
within experimental error for pure PC bilayer wihtout ions, indicating structural inaccuracies with varying severity for all
...
and therefore supporting the validity of the electrometer concept in simulations~\cite{akutsu81,altenbach84,seelig87,scherer89}. 
% In experiments the concept is well validified already by Seelig et al.
...
I THINK THE PROBLEM IS THAT THERE ARE DOZENS, IF NOT HUNDREDS, OF THESE PAPERS,
THUS WE CANNOT LIST THEM ALL. ON THE OTHER HAND, IT WOULD BE VERY DIFFICULT TO CHOOSE
WHICH ONES TO FAIRLY POINT OUT. FOR THIS REASON MY OPINION IS THAT THE GENERAL STATEMENT
IN THE LAST PARAGRAPH OF CONCLUSIONS WITH CITATIONS TO RECENT PAPERS IN HIGH IMPACT JOURNALS IS ENOUGH.
ON THE OTHER HAND, WE SHOULD NOT BE TOO LAME EITHER SO MAYBE SOME MENTION TO HERE COULD BE CONSIDERED. 
Sorry about writing capitals. SAMULI
}
...
MONTICELLI:I think these simulations were actually carried out by Samuli, no?
OLLILA: Yes, but this is unpublished model so I do not know how much I can tell about this.}
