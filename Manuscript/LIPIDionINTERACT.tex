...
%
Area per lipid was found to reduce in simulations upon Na$^+$ binding (e.g. Refs.~\cite{})
in agreement with AFM experiments~\cite{manyes05,manyes06,fukuma07,ferber11,morata12};
however, the reduction in area was observed at extremely low (millimolar) Na$^+$ concentrations, 
whereas molar concentrations were required to reproduce the effect in scattering experiments~\cite{pabst07}.
%
Lipid lateral diffusion was reported to be reduced in
some simulation studies (e.g. Refs.~\cite{bockmann03}) upon Na$^+$ binding,
