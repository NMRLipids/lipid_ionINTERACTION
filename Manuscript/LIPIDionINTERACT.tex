...
It is generally agreed that the relative ion binding affinities
...
In atomistic molecular dynamics (MD) simulations phospholipid bilayers commonly bind Na${^+}$,
although the binding strength depends on the model~\cite{bockmann03,bockmann04,sachs04,berkowitz06,cordomi08,cordomi09,valley11,berkowitz12}.
