...
The apparent contradictions in the results from previous molecular dynamics simulations~\cite{bockmann03,bockmann04}, 
...
{\it Claire Loison provided results for CHARMM36 DPPC+CaCl_{2} with Yoo's model.} \\
{\it Josef Melcr} \\
...
{\it Joona Tynkkynen } \\
{\it Sergey Vilov provided results for CHARMM36 DPPC+CaCl_{2} with Yoo's model.} \\
