...
Area per lipid was found to reduce in simulations upon Na$^+$ binding (e.g. Refs.~\cite{bockmann03,cordomi08})
in agreement with AFM experiments~\cite{manyes05,manyes06,fukuma07,ferber11,morata12};
however, the reduction in area was observed at sub-molar Na$^+$ concentrations, 
...
(e.g., experiments with amphiphilic cations~\cite{scherer89,franzin98}), however, such simulation data is not
currently available.
