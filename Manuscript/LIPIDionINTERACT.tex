...
using the choline headgroup order parameters according to the 'molecular electrometer' concept [Seelig \textit{et al., Biochemistry}, 1987, \textbf{26}, 7535].%~\cite{seelig87}.
...
Concerning contradictions in MD simulation results, we reinterpret strong Na$^+$ binding as an artefact of several simulation models, e.g., the Berger model used in Refs.~\cite{bockmann03,bockmann04}.
...
This can be rationalised with higher and more equilibrated binding affinity in long simulations. 
...
\noindent 
{\it Andrea Catte} \\
{\it Mykhailo Girych} ran and analysed several simulations. Discussed the project actively with OHSO. \\
...
{\it Josef Melcr} performed and analysed several simulations; discussed the project actively; corrected and contributed to the manuscript. \\
