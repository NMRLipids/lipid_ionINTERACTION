...
show stronger Na$^+$ binding affinity (see Fig.~\ref{NAdensities}). Thus we conclude that the sodium binding affinity
...
However, in CHARMM36 with ion model by Yoo et al. the order parameter decrease is overestimated for $\beta$ 
