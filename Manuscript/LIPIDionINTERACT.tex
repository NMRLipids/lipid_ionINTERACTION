...
On the other hand, the choline order parameter changes with NaCl are clearly overestimated in all other tested models (see Fig.~\ref{ordPions}).
...
Especially interactions between charged molecules and lipid bilayer are significantly
affected since strong Na$^+$ binding makes bilayer effectively positively charged.

All the tested models overestimate the order parameter decrease as a function of CaCl$_2$ concentration
