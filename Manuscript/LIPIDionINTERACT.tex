...
\begin{tabular}{c c c c c c c c c c c}
  ...
  Force field (lipid, ion)& lipid & salt & [salt] (mM) & \footnote{The number of lipid molecules}N$_{\rm l}$   &  \footnote{The number of water molecules}N$_{\rm w}$   & \footnote{The number of cations}N$_{\rm c}$  & \footnote{Simulation temperature}T (K)  & \footnote{The total simulation time}t$_{{\rm sim}}$(ns) & \footnote{Time frames used in the analysis}t$_{{\rm anal}}$ (ns) & \footnote{Reference for simulation files}Files\\
  \hline
  ...
  %\hdashline
  Berger-POPC-07\cite{ollila07a}, ffgmx\cite{straatsma88}  &   " & CaCl$_2$ & 340  & " 	& 7157 & 44 & " & 108 & 58 &\citenum{bergerPOPC340mMCaClfiles}  \\
  %\hline
  ...
  CHARMM36\cite{klauda10}   & " & " & 0           & 72 							& 2242 & 0  & "  & 30 & 20 & \citenum{charmm36filesSHORT} \\
  ...
  MacRog\cite{maciejewski14}  & " & " & 0 & 288 								& 14400 & 0 & " & 90 & 40  & \citenum{macrogdehydFILES}  \\  
