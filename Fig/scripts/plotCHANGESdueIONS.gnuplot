...
plot "../../Data/DPPC/NaCl/EXP-Akutsu1981-DPPC-NaClchange.dat"  using 1:($2*-0.00784) title 'DPPC+NaCl, ^2H NMR, T=323K' with linespoints  linetype 1 pt 7 lc rgb 'black', \
     "../../Data/POPC/NaCl/BERGER/BERGERnaclCONSchange.dat" using 1:2:3 with yerrorbars notitle pt 5 lt 1 lc rgb 'red', "" using 1:2 with linespoint title 'POPC+NaCl, Berger, T=298K' pt 5 linetype 1 lc rgb 'red', \
     "../../Data/POPC/NaCl/BERGER/BERGERnaclCONSchange.dat" using 1:4:5 with yerrorbars notitle  pt 5 lt 1 lc rgb 'green', "" using 1:4 with lines notitle linetype 1 lc rgb 'red', \
     ...
     "../../Data/POPC/NaCl/SLIPID/SLIPIDnaclCONSchangeSD.dat" using 1:2:3 with yerrorbars notitle pt 5 lt 1 lc rgb 'violet', "" using 1:2 with linespoint title 'POPC+NaCl, SLIPID, T=310K' pt 5 linetype 1 lc rgb 'violet', \
     "../../Data/POPC/NaCl/SLIPID/SLIPIDnaclCONSchangeSD.dat" using 1:4:5 with yerrorbars notitle  pt 5 lt 1 lc rgb 'violet', "" using 1:4 with lines notitle linetype 1 lc rgb 'violet', \
     "../../Data/DPPC/NaCl/SLIPIDS/SLIPIDnaclCONSchangeRX.dat" using 1:2:3 with yerrorbars notitle pt 7 lt 1 lc rgb 'violet', "" using 1:2 with linespoint title 'DPPC+NaCl, SLIPID, T=323K' pt 7 linetype 1 lc rgb 'violet', \
     "../../Data/DPPC/NaCl/SLIPIDS/SLIPIDnaclCONSchangeRX.dat" using 1:4:5 with yerrorbars notitle  pt 7 lt 1 lc rgb 'violet', "" using 1:4 with lines notitle linetype 1 lc rgb 'violet', \
...
plot "../../Data/DPPC/NaCl/EXP-Akutsu1981-DPPC-CaClchange-T332.dat"  using 1:($2*-0.00784) title 'DPPC+CaCl_2, ^2H NMR, T=332K' with linespoints  linetype 1 pt 6 lc rgb 'black', \
     ...
     "../../Data/DPPC/CaCl/CHARMM36/CHARMMcaclCONSchangeYOO.dat" using 1:2:3 with yerrorbars notitle pt 6 lt 1 lc rgb 'green', "" using 1:2 with linespoint title 'DPPC+CaCl_2, CHARMM YOO' pt 6 linetype 1 lc rgb 'green', \
     "../../Data/DPPC/CaCl/CHARMM36/CHARMMcaclCONSchangeYOO.dat" using 1:4:5 with yerrorbars notitle  pt 6 lt 1 lc rgb 'green', "" using 1:4 with lines notitle linetype 1 lc rgb 'green',\
...
plot "../../Data/DPPC/NaCl/EXP-Akutsu1981-DPPC-NaClchange.dat"  using 1:($3*0.00784) notitle with linespoints  linetype 1 pt 7 lc rgb 'black', \
     ...
     "../../Data/POPC/NaCl/SLIPID/SLIPIDnaclCONSchangeSD.dat" using 1:6:7  with yerrorbars notitle pt 5 lt 1 lc rgb 'violet', "" using 1:6 with lines notitle linetype 1 lc rgb 'violet', \
     "../../Data/POPC/NaCl/SLIPID/SLIPIDnaclCONSchangeSD.dat" using 1:8:9  with yerrorbars notitle pt 5 lt 1 lc rgb 'violet', "" using 1:8 with lines notitle linetype 1 lc rgb 'violet',\
     "../../Data/DPPC/NaCl/SLIPIDS/SLIPIDnaclCONSchangeRX.dat" using 1:6:7  with yerrorbars notitle pt 7 lt 1 lc rgb 'violet', "" using 1:6 with lines notitle linetype 1 lc rgb 'violet', \
     "../../Data/DPPC/NaCl/SLIPIDS/SLIPIDnaclCONSchangeRX.dat" using 1:8:9  with yerrorbars notitle pt 7 lt 1 lc rgb 'violet', "" using 1:8 with lines notitle linetype 1 lc rgb 'violet',\
...
plot "../../Data/DPPC/NaCl/EXP-Akutsu1981-DPPC-CaClchange-T332.dat"  using 1:($3*0.00784) notitle with linespoints  linetype 1 pt 6 lc rgb 'black', \
     ...
     "../../Data/DPPC/CaCl/CHARMM36/CHARMMcaclCONSchangeYOO.dat"  using 1:6:7  with yerrorbars notitle pt 6 lt 1 lc rgb 'green', "" using 1:6 with lines notitle linetype 1 lc rgb 'green', \
     "../../Data/DPPC/CaCl/CHARMM36/CHARMMcaclCONSchangeYOO.dat" using 1:8:9  with yerrorbars notitle pt 6 lt 1 lc rgb 'green', "" using 1:8 with lines notitle linetype 1 lc rgb 'green',\
