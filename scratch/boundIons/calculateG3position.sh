# Script to calculate the average position of a g3 carbon for each leaflet
#
# Note, expects FIVE inputs!
#
# Usage example: ./calculateG3position.sh mappingPOPCcharmm.txt popcRUN2.tpr centered.xtc g3distribution.xvg 150
#
...
echo
echo "Will calculate the POSITIONS of g3 peaks for each leaflet."
