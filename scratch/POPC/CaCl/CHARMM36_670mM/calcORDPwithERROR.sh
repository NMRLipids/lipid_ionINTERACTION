...
tprname=popcRUN7.tpr
trajname=traj80-200ns.xtc
starttime=0
outputname=OrderParameters80-200ns.dat
#echo 'q
#' | make_ndx -f $tprname
...
paste OrderParametersAV.dat OrderParametersSDsum.dat | awk -v sum=$sum '{print $1" "sqrt($2/sum)/sqrt(sum)}' >> $outputname 
