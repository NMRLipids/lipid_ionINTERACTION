tmpDIRname=ORANGE_26ca_OPtmp
mkdir $tmpDIRname
cd $tmpDIRname
cp ../calcORDPorange.sh ./
cp ../gro_OP.awk ./
trajname=/wrk/ollilas1/POPCdata/POPCorange/POPCcacl/popcRUN2.trr
tprname402=/wrk/ollilas1/POPCdata/POPCorange/POPCcacl/402/popc402.tpr
hdbfile=/wrk/ollilas1/POPCdata/POPCorange/POPCcacl/ffgmx2.hdb
cp $hdbfile ./
starttime=0
numberOFlipids=72
outFILE=../../Data/POPC/CaCl/ORANGE/26ca/OrderParameters.dat
