tmpDIRname=CHARMM_26ca_OPtmp
mkdir $tmpDIRname
cd $tmpDIRname
cp ../calcORDPcharmm.sh ./
cp ../gro_OP.awk ./
trajname=/wrk/ollilas1/POPCdata/POPCcharmm/POPCcacl/26CA/traj80-200ns.xtc
tprname=/wrk/ollilas1/POPCdata/POPCcharmm/POPCcacl/26CA/popcRUN3.tpr
numberOFlipids=72
outFILE=../../Data/POPC/CaCl/CHARMM36/26ca/OrderParameters.dat
