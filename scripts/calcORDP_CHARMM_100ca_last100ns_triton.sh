tmpDIRname=CHARMM_100ca_OPtmp_trit
mkdir $tmpDIRname
cd $tmpDIRname
cp ../calcORDPcharmm.sh ./
cp ../gro_OP.awk ./
trajname=/triton/becs/work/girychm1/24_11_15/1m_popc_crm/gromacs/1m_popc_crm_192ns.xtc
tprname=/triton/becs/work/girychm1/24_11_15/1m_popc_crm/gromacs/200ns_run.tpr
numberOFlipids=128
outFILE=../../Data/POPC/CaCl/CHARMM36/100ca/OrderParameters_last100ns.dat
