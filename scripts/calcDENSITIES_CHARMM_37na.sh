tmpDIRname=CHARMM36_37na_DENStmp
mkdir $tmpDIRname
cd $tmpDIRname
...
outFILE=../../Data/POPC/NaCl/CHARMM36/37na/LIPIDdensity.xvg
groFILE=/wrk/ollilas1/POPCdata/POPCcharmm/POPCnacl/37na/popcRUN2.gro
