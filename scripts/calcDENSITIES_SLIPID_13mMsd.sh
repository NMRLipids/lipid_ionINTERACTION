...
tmpDIRname=SLIPID_130mMsd_DENStmp
mkdir $tmpDIRname
cd $tmpDIRname
trajname=/work/ollilas1/POPCdata/POPCslipids/130mMsd/md.xtc
tprname=/work/ollilas1/POPCdata/POPCslipids/130mMsd/md.tpr
outFILE=../../Data/POPC/NaCl/SLIPID/130mMsd/LIPIDdensity.xvg
