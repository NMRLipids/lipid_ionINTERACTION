tmpDIRname=SLIPID_750mMsdSCALED_OPtmp
mkdir $tmpDIRname
cd $tmpDIRname
cp ../calcORDPslipid.sh ./
cp ../gro_OP.awk ./
trajname=/work/ollilas1/POPCdata/POPCslipids/750mMscaled/750.xtc
tprname=/work/ollilas1/POPCdata/POPCslipids/750mMscaled/750.tpr
numberOFlipids=200
outFILE=../../Data/POPC/NaCl/SLIPID/750mMscaled/OrderParameters.dat
