tmpDIRname=CHARMM36_78na_DENStmp
mkdir $tmpDIRname
cd $tmpDIRname
trajname=/wrk/ollilas1/POPCdata/POPCcharmm/POPCnacl/78na/popcRUN2-4.trr
...
outFILE=../../Data/POPC/NaCl/CHARMM36/78na/LIPIDdensity.xvg
groFILE=/wrk/ollilas1/POPCdata/POPCcharmm/POPCnacl/78na/popcRUN2.gro
