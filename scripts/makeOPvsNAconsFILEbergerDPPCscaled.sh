outfile=../Data/DPPC/NaCl/BERGER/OPvsNACLconsSCALED.dat
rm "$outfile"
...
paste -sd " " ../Data/DPPC/NaCl/BERGER/8naSCALED/OrderParameters.dat > tmp.dat 
awk '{print "150 "$0}' tmp.dat >> "$outfile" 
paste -sd " " ../Data/DPPC/NaCl/BERGER/51naSCALED/OrderParameters.dat > tmp.dat 
