...
tmpDIRname=SLIPID_450CAmMscaled_DENStmp
mkdir $tmpDIRname
cd $tmpDIRname
trajname=/work/ollilas1/POPCdata/POPCslipids/450mMCaClSCALED/md.xtc
tprname=/work/ollilas1/POPCdata/POPCslipids/450mMCaClSCALED/md.tpr
outFILE=../../Data/POPC/CaCl/SLIPID/450mMscaled/LIPIDdensity.xvg
