tmpDIRname=LIPID14_12na_OPtmp
mkdir $tmpDIRname
cd $tmpDIRname
cp ../calcORDPlipid14.sh ./
cp ../gro_OP.awk ./
trajname=/work/ollilas1/POPCdata/POPClipid14/12na/015_popc_amb_0_200ns.xtc
tprname=/work/ollilas1/POPCdata/POPClipid14/12na/run_200ns_gpu.tpr
numberOFlipids=128
outFILE=../../Data/POPC/NaCl/LIPID14/12na/OrderParameters.dat
