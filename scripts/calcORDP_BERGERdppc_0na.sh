tmpDIRname=BERGERdppc_0na_OPtmp
mkdir $tmpDIRname
cd $tmpDIRname
cp ../calcORDPberger.sh ./
cp ../gro_OP.awk ./
trajname=/wrk/ollilas1/DPPCdata/DPPCberger/0na/md.xtc
tprname402=/wrk/ollilas1/DPPCdata/DPPCberger/0na/402.tpr
hdbfile=../../scratch/ffgmx2bergerDPPC.hdb
cp $hdbfile ./ffgmx2.hdb
starttime=10000
#endtime=240000
numberOFlipids=72
outFILE=../../Data/DPPC/NaCl/BERGER/0na/OrderParameters.dat
