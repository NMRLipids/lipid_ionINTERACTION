tmpDIRname=ULM_0na_OPtmpMATTI
mkdir $tmpDIRname
cd $tmpDIRname
cp ../calcORDPulmschneider.sh ./
cp ../gro_OP.awk ./
trajname=/wrk/ollilas1/POPCdata/POPCulmschneider/md_dc.xtc
tprname402=/wrk/ollilas1/POPCdata/POPCulmschneider/402.tpr
hdbfile=../../scratch/ffgmx2_ULM_POPC.hdb
cp $hdbfile ./ffgmx2.hdb
starttime=0
#endtime=240000
numberOFlipids=128
outFILE=../../Data/POPC/NaCl/ULM/0na/OrderParametersMATTI.dat
