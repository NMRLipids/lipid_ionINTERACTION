#!/bin/bash
tmpDIRname=BERGER_DMPC50molDMTAP_OPtmp
mkdir $tmpDIRname
cd $tmpDIRname
cp ../calcORDPbergerDMPC.sh ./
cp ../gro_OP.awk ./
trajname=/m/nbe/work/ollilas1/DMPCdata/DMPCberger/DMPC_DMTAP/50molDMTAP/tap50W_41-190ns.xtc
tprname=/m/nbe/work/ollilas1/DMPCdata/DMPCberger/DMPC_DMTAP/50molDMTAP/tap50W_150ns.tpr
tprname402=/m/nbe/work/ollilas1/DMPCdata/DMPCberger/DMPC_DMTAP/50molDMTAP/tap50W_150ns.tpr
hdbfile=/m/nbe/work/ollilas1/DMPCdata/ffgmx2.hdb
cp $hdbfile ./
starttime=0
numberOFlipids=64
outFILE=../../Data/DMPC/DMPC_DMTAP/50molDMTAP/OrderParameters.dat
