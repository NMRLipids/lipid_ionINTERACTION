...
tmpDIRname=ULM_77na_DENStmp
mkdir $tmpDIRname
cd $tmpDIRname
trajname=/work/girychm1/19_5_15/1m_popc_ulm/1m_popc_ulm_200.xtc
tprname=/work/girychm1/19_5_15/1m_popc_ulm/run_200ns_gpu.tpr
mappingFILE=../../MAPPING/mappingPOPClipid14.txt
outFILE=../../Data/POPC/NaCl/ULM/77na/LIPIDdensity.xvg
groFILE=/work/girychm1/19_5_15/1m_popc_ulm/confout.gro
