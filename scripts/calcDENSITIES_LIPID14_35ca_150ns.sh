...
tmpDIRname=LIPID14_35ca_DENStmp
mkdir $tmpDIRname
cd $tmpDIRname
trajname=/work/girychm1/24_11_15/035m_popc_amb/035_amb_200ns.xtc
tprname=/work/girychm1/24_11_15/035m_popc_amb/035M_CaCl2_POPC_AMB.tpr
mappingFILE=../../MAPPING/mappingPOPClipid14.txt
outFILE=../../Data/POPC/CaCl/LIPID14/35ca/LIPIDdensity_150ns.xvg
groFILE=/work/girychm1/24_11_15/035m_popc_amb/confout.gro
...
#CLindexNR=4
echo $LIPIDindexNR System | trjconv -f $trajname -s $tprname -fit progressive -o ANALtraj.xtc -b 100000 -e 150000
