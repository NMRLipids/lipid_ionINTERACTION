tmpDIRname=CHARMM_67ca_OPtmp_trit
mkdir $tmpDIRname
cd $tmpDIRname
cp ../calcORDPcharmm.sh ./
cp ../gro_OP.awk ./
trajname=/triton/becs/work/girychm1/2_12_15/067_ca_crm_popc/gromacs/067M_CaCl2_POPC_CRM36_003ns_200ns.xtc
tprname=/triton/becs/work/girychm1/2_12_15/067_ca_crm_popc/gromacs/067M_CaCl2_POPC_CRM36.tpr
numberOFlipids=128
outFILE=../../Data/POPC/CaCl/CHARMM36/67ca/OrderParameters_last100ns.dat
...
do
    rm runPROT.gro
    echo "$j" | trjconv_mpi -f $trajname -s $tprname -o runPROT.gro -n index.ndx -pbc res -b 97000
