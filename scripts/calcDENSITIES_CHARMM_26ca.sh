tmpDIRname=CHARMM36_26ca_DENStmp
mkdir $tmpDIRname
cd $tmpDIRname
trajname=/wrk/ollilas1/POPCdata/POPCcharmm/POPCcacl/26CA/traj80-200ns.xtc
tprname=/wrk/ollilas1/POPCdata/POPCcharmm/POPCcacl/26CA/popcRUN2.tpr
mappingFILE=../../../NmrLipidsCholXray/MAPPING/mappingPOPCcharmm.txt
outFILE=../../Data/POPC/CaCl/CHARMM36/26ca/LIPIDdensity.xvg
groFILE=/wrk/ollilas1/POPCdata/POPCcharmm/POPCcacl/26CA/popcRUN3.gro
