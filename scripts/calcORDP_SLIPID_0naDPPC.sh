tmpDIRname=SLIPID_0naDPPC_OPtmp
mkdir $tmpDIRname
cd $tmpDIRname
cp ../calcORDPslipid.sh ./
cp ../gro_OP.awk ./
trajname=/work/ollilas1/DPPCdata/DPPCslipids/0na/mdnew.xtc
tprname=/work/ollilas1/DPPCdata/DPPCslipids/0na/mdnew.tpr
numberOFlipids=128
outFILE=../../Data/DPPC/NaCl/SLIPIDS/0na/OrderParameters.dat
