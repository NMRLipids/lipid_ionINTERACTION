tmpDIRname=ORANGE_7na_OPtmp
mkdir $tmpDIRname
cd $tmpDIRname
cp ../calcORDPorange.sh ./
cp ../gro_OP.awk ./
trajname=/wrk/ollilas1/POPCdata/POPCorange/POPCnacl/7NaCl/popcRUN2.trr
tprname402=/wrk/ollilas1/POPCdata/POPCorange/POPCnacl/7NaCl/402/popc402.tpr
hdbfile=/wrk/ollilas1/POPCdata/POPCorange/POPCnacl/7NaCl/ffgmx2.hdb
cp $hdbfile ./
starttime=0
numberOFlipids=72
outFILE=../../Data/POPC/NaCl/ORANGE/7na/OrderParameters.dat
