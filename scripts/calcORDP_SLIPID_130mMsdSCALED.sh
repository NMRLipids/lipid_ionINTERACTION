tmpDIRname=SLIPID_13mMsdSCALED_OPtmp
mkdir $tmpDIRname
cd $tmpDIRname
cp ../calcORDPslipid.sh ./
cp ../gro_OP.awk ./
trajname=/work/ollilas1/POPCdata/POPCslipids/130mMscaled/130.xtc
tprname=/work/ollilas1/POPCdata/POPCslipids/130mMscaled/130.tpr
numberOFlipids=200
outFILE=../../Data/POPC/NaCl/SLIPID/130mMscaled/OrderParameters.dat
