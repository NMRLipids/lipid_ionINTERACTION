...
mkdir $tmpDIRname
cd $tmpDIRname
trajname=/work/ollilas1/POPCdata/POPCcharmm/POPCcacl/450mMscaled/md.xtc
tprname=/work/ollilas1/POPCdata/POPCcharmm/POPCcacl/450mMscaled/md.tpr
mappingFILE=../../../NmrLipidsCholXray/MAPPING/mappingPOPCcharmm.txt
outFILE=../../Data/POPC/CaCl/CHARMM36/73caSCALED/LIPIDdensity.xvg
groFILE=/wrk/ollilas1/POPCdata/POPCcharmm/POPCcacl/450mMscaled/start.gro
