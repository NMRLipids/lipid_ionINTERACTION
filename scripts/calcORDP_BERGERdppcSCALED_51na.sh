tmpDIRname=BERGERdppcSCALED_51na_OPtmp
mkdir $tmpDIRname
cd $tmpDIRname
cp ../calcORDPberger.sh ./
cp ../gro_OP.awk ./
trajname=/wrk/ollilas1/DPPCdata/DPPCberger/51naSCALED/md.xtc
tprname402=/wrk/ollilas1/DPPCdata/DPPCberger/51naSCALED/402.tpr
hdbfile=../../scratch/ffgmx2bergerDPPC.hdb
cp $hdbfile ./ffgmx2.hdb
starttime=60000
#endtime=240000
numberOFlipids=72
outFILE=../../Data/DPPC/NaCl/BERGER/51naSCALED/OrderParameters.dat
