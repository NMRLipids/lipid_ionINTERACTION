...
numberOFlipids=128
outFILE=../../Data/POPC/CaCl/LIPID14/35ca/OrderParameters_last100ns.dat
...
do
    rm runPROT.gro
    echo "$j" | trjconv -f $trajname -s $tprname -o runPROT.gro -n index.ndx -pbc res -b 100000
