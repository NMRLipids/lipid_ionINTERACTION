tmpDIRname=BERGERopls_8na_OPtmp
mkdir $tmpDIRname
cd $tmpDIRname
cp ../calcORDPbergerOPLS.sh ./
cp ../gro_OP.awk ./
trajname=/wrk/ollilas1/DPPCdata/DPPCbergerOPLS/8naSCALED/md.xtc
tprname402=/wrk/ollilas1/DPPCdata/DPPCbergerOPLS/8naSCALED/402.tpr
hdbfile=/wrk/ollilas1/DPPCdata/DPPCbergerOPLS/0na/ffgmx2.hdb
cp $hdbfile ./
starttime=60000
#endtime=240000
numberOFlipids=72
outFILE=../../Data/DPPC/NaCl/BERGERopls/8naSCALED/OrderParameters.dat
