tmpDIRname=ULM_12na_OPtmp
mkdir $tmpDIRname
cd $tmpDIRname
cp ../calcORDPulmschneider.sh ./
cp ../gro_OP.awk ./
trajname=/wrk/ollilas1/POPCdata/POPCulmschneider/12na/015_popc_ulm_200.xtc
tprname402=/wrk/ollilas1/POPCdata/POPCulmschneider/12na/402.tpr
hdbfile=../../scratch/ffgmx2_ULM_POPC.hdb
cp $hdbfile ./ffgmx2.hdb
starttime=0
#endtime=240000
numberOFlipids=128
outFILE=../../Data/POPC/NaCl/ULM/12na/OrderParameters.dat
