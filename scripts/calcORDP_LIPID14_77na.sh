tmpDIRname=LIPID14_77na_OPtmp
mkdir $tmpDIRname
cd $tmpDIRname
cp ../calcORDPlipid14.sh ./
cp ../gro_OP.awk ./
trajname=/work/ollilas1/POPCdata/POPClipid14/77na/1m_popc_amb_0_200ns.xtc
tprname=/work/ollilas1/POPCdata/POPClipid14/77na/run_200ns_gpu.tpr
numberOFlipids=128
outFILE=../../Data/POPC/NaCl/LIPID14/77na/OrderParameters.dat
