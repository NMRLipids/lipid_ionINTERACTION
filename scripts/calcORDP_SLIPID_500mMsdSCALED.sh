tmpDIRname=SLIPID_500mMsdSCALED_OPtmp
mkdir $tmpDIRname
cd $tmpDIRname
cp ../calcORDPslipid.sh ./
cp ../gro_OP.awk ./
trajname=/work/ollilas1/POPCdata/POPCslipids/500mMscaled/500.xtc
tprname=/work/ollilas1/POPCdata/POPCslipids/500mMscaled/500.tpr
numberOFlipids=200
outFILE=../../Data/POPC/NaCl/SLIPID/500mMscaled/OrderParameters.dat
