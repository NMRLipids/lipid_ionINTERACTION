tmpDIRname=SLIPID_300mMsdSCALED_OPtmp
mkdir $tmpDIRname
cd $tmpDIRname
cp ../calcORDPslipid.sh ./
cp ../gro_OP.awk ./
trajname=/work/ollilas1/POPCdata/POPCslipids/300mMscaled/300.xtc
tprname=/work/ollilas1/POPCdata/POPCslipids/300mMscaled/300.tpr
numberOFlipids=200
outFILE=../../Data/POPC/NaCl/SLIPID/300mMscaled/OrderParameters.dat
