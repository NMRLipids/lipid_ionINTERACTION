...
cp ../gro_OP.awk ./
trajname=/wrk/girychm1/30_11_15/0m_popc_ulm_v_Matti/traj.trr
tprname402=/wrk/ollilas1/HGmodel/NMRlipids/lipid_ionINTERACTION/scratch/402.tpr
hdbfile=../../scratch/ffgmx2_ULM_POPC.hdb
cp $hdbfile ./ffgmx2.hdb
starttime=0
#endtime=240000
numberOFlipids=128
outFILE=../../Data/POPC/NaCl/ULM/0na/OrderParametersMATTIinitSTRUCT.dat
