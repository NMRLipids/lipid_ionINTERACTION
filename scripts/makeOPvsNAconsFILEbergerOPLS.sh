outfile=../Data/DPPC/NaCl/BERGERopls/OPvsNACLcons.dat
rm "$outfile"
...
paste -sd " " ../Data/DPPC/NaCl/BERGERopls/8na/OrderParameters.dat > tmp.dat 
awk '{print "150 "$0}' tmp.dat >> "$outfile" 
paste -sd " " ../Data/DPPC/NaCl/BERGERopls/51na/OrderParameters.dat > tmp.dat 
