tmpDIRname=SLIPID_1000mMsdSCALED_OPtmp
mkdir $tmpDIRname
cd $tmpDIRname
cp ../calcORDPslipid.sh ./
cp ../gro_OP.awk ./
trajname=/work/ollilas1/POPCdata/POPCslipids/1000mMscaled/1000.xtc
tprname=/work/ollilas1/POPCdata/POPCslipids/1000mMscaled/1000.tpr
numberOFlipids=200
outFILE=../../Data/POPC/NaCl/SLIPID/1000mMscaled/OrderParameters.dat
