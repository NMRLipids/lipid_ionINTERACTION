tmpDIRname=MACROG_27na_DENStmp
mkdir $tmpDIRname
cd $tmpDIRname
#source for data:
#wget https://zenodo.org/record/14976/files/100.tpr
#wget https://zenodo.org/record/14976/files/100mM_50ns_100ps.xtc
trajname=/wrk/ollilas1/POPCdata/POPCmacrog/POPCnacl/27na/100mM_50ns_100ps.xtc
tprname=/wrk/ollilas1/POPCdata/POPCmacrog/POPCnacl/27na/100.tpr
mappingFILE=../../../NmrLipidsCholXray/MAPPING/mappingPOPCmacrog.txt
outFILE=../../Data/POPC/NaCl/MACROG/27na/LIPIDdensity.xvg
