tmpDIRname=SLIPID_0na_OPtmp
mkdir $tmpDIRname
cd $tmpDIRname
cp ../calcORDPslipid.sh ./
cp ../gro_OP.awk ./
trajname=/wrk/ollilas1/POPCdata/POPCslipids/0na/md.xtc
tprname=/wrk/ollilas1/POPCdata/POPCslipids/0na/md.tpr
numberOFlipids=128
outFILE=../../Data/POPC/NaCl/SLIPID/0na/OrderParameters.dat
