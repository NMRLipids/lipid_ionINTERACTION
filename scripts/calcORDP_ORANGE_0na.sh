tmpDIRname=ORANGE_0na_OPtmp
mkdir $tmpDIRname
cd $tmpDIRname
cp ../calcORDPorange.sh ./
cp ../gro_OP.awk ./
trajname=/wrk/ollilas1/POPCdata/POPCorange/popcRUN_10-60ns.xtc
tprname402=/wrk/ollilas1/POPCdata/POPCorange/402/popc402.tpr
hdbfile=/wrk/ollilas1/POPCdata/POPCorange/ffgmx2.hdb
cp $hdbfile ./
starttime=0
numberOFlipids=72
outFILE=../../Data/POPC/NaCl/ORANGE/0na/OrderParameters.dat
