tmpDIRname=ULM_0na_OPtmpGROUP
mkdir $tmpDIRname
cd $tmpDIRname
cp ../calcORDPulmschneider.sh ./
cp ../gro_OP.awk ./
trajname=/wrk/ollilas1/POPCdata/POPCulmschneider/0na/popc_ulm_200ns_group.xtc
tprname402=/wrk/ollilas1/POPCdata/POPCulmschneider/0na/402.tpr
hdbfile=../../scratch/ffgmx2_ULM_POPC.hdb
cp $hdbfile ./ffgmx2.hdb
starttime=0
#endtime=240000
numberOFlipids=128
outFILE=../../Data/POPC/NaCl/ULM/0na/OrderParametersGROUP.dat
