...
outFILE=../../Data/POPC/CaCl/LIPID14/35ca/LIPIDdensity_100ns.xvg
...
#CLindexNR=4
echo $LIPIDindexNR System | trjconv -f $trajname -s $tprname -fit progressive -o ANALtraj.xtc -b 50000 -e 100000
